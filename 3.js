...
class BlackTeaMaker extends TeaMaker {
  // Робимо метод addCondiments, який виводить в консоль Додаємо молоко так цукор, щоб приготувати чорний чай...
  addCondiments() {
    console.log(`Додаємо молоко так цукор, щоб приготувати чорний чай...`);
  }
}
